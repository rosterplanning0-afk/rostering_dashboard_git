...
profile_page      = st.Page("pages/7_Employee_Profile.py",             title="Competency Management", icon="👤")
...
ADMIN_SECTION_TITLES = {"Admin", "Fatigue Management", "Raw Data Explorer", "Competency Management"}
